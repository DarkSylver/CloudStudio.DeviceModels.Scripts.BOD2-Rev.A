...
# Parsing + Configuration Script – BOD 2 - Rev. A

This **Parsing + Configuration** script is designed for the **BOD 2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – BOD 2 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **BOD 2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
